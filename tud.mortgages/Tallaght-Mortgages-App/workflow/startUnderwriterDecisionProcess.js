...
const { UNDERWRITER_DECISION_API, UNDERWRITER_TOPIC_ARN, WEBSOCKET_TABLE_NAME, WEBSOCKET_ENDPOINT, STEP_FUNCTION_TABLE_NAME } = process.env;
...
*/
     ...
     */
        ...
        await notificationUtil.publishWebSocket('Underwriter', params.Subject, 'Warning' ,WEBSOCKET_TABLE_NAME, WEBSOCKET_ENDPOINT);
